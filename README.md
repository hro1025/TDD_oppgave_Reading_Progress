...
>
> ChatGPT acts as the grader, and the submission is evaluated **only** against the criteria described here.
>
...
- ✔ **Test-Driven Development (Red → Green → Refactor)** followed correctly  
- ✔ A **single evolving domain model** (`ReadingProgress`) used throughout  
...
- ✔ Hardcoded logic **introduced intentionally and removed via refactoring**  
- ✔ Refactoring preserved behavior while improving design clarity  
- ✔ Solution remained **pure domain logic**, with no UI or external concerns  
